...
import { BarChart3, Database, Network, Cpu, CreditCard, Menu, X, LogOut } from "lucide-react"
...
export function Navbar() {
    ...
    return (
        <header className="fixed top-0 left-0 right-0 z-50 flex items-center justify-center p-4 md:p-6 pointer-events-none">
            ...
            <div className="flex flex-col md:flex-row md:items-center gap-3 px-2 py-2 glass-card rounded-2xl md:rounded-full pointer-events-auto border-white/5 shadow-[0_10px_40px_-10px_rgba(0,0,0,0.5)] w-full max-w-sm md:max-w-fit transition-all duration-500">
                ...
                <nav className="hidden md:flex items-center gap-1">
                    ...
                    <button
                        ...
                        className="px-4 py-2.5 rounded-xl text-sm font-medium text-red-400 hover:text-red-300 hover:bg-red-500/10 transition-all duration-300 flex items-center gap-2.5 ml-2"
                    >
                ...
                <AnimatePresence>
                    {isMobileMenuOpen && (
                        ...
                        >
                            ...
                            <button
                                onClick={handleLogout}
                                className="px-4 py-3 rounded-xl text-sm font-medium text-red-400 hover:text-red-300 hover:bg-red-500/10 transition-all duration-300 flex items-center gap-3"
                            >
                                <LogOut className="w-4 h-4" />
                                <span className="tracking-wide">Logout</span>
                            </button>
